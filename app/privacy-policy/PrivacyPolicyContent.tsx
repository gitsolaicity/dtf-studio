  ...
  return (
    <>
      <div className="max-w-3xl mx-auto px-4 py-28 text-base leading-relaxed text-gray-800 dark:text-gray-200">
        ...
        <p className="mb-4">
          Ця політика конфіденційності описує, як компанія{" "}
          <strong>Blacklight</strong> (далі — «ми», «наш сайт»,
          «Blacklight365.com») збирає, використовує та захищає персональні дані
          користувачів.
        </p>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>
            Інформація про обрані послуги (DTF-друк, шовкографія, машинна
            вишивка)
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>
            Для надсилання оновлень або спеціальних пропозицій (за вашою згодою)
          </li>
        </ul>

        <h2 className="text-xl font-semibold mt-8 mb-4">3. Захист даних</h2>
        <p className="mb-4">
          Ми використовуємо сучасні технічні та організаційні заходи для захисту
          ваших даних від несанкціонованого доступу, втрати або розголошення.
        </p>
        ...
        <p className="mb-4">
          Наш сайт може використовувати файли cookies та інструменти аналітики
          (наприклад, Vercel Analytics) для покращення роботи сайту та аналізу
